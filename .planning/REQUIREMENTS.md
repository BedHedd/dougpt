...
- [x] **ASR-02**: User can generate timestamped speech transcripts locally without paid APIs.
- [x] **ASR-03**: User can export normalized transcript segments with confidence metadata for alignment.
...
| ASR-02 | Phase 2 | Complete |
| ASR-03 | Phase 2 | Complete |
